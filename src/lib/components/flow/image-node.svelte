...
<section class="img-node">
		...
		<aside>
			...
			>
				<svg width="6" height="9" viewBox="0 0 6 9" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path
						d="M6 0.5H4.5L4.07143 0H1.92857L1.5 0.5H0V1.5H6M0.428571 8C0.428571 8.26522 0.518877 8.51957 0.679623 8.70711C0.840368 8.89464 1.05839 9 1.28571 9H4.71429C4.94161 9 5.15963 8.89464 5.32038 8.70711C5.48112 8.51957 5.57143 8.26522 5.57143 8V2H0.428571V8Z"
						fill="#886D4F"
					/>
				</svg>
			</button>
	...
	<footer>
		<img alt={$title} src={source_web_reference} />
	</footer>
...
<style>
	...
	header {
		...
		background: linear-gradient(0deg, rgba(133, 110, 84, 0.2) 0.3%, rgba(133, 110, 84, 0) 60.73%),
